...
const metadata = { title: 'Free Excel Data Cleaner | Pratix.io', description: 'Clean Excel and spreadsheet data in your browser by removing empty rows and duplicates privately.', route: '/en/excel-data-cleaner' };
